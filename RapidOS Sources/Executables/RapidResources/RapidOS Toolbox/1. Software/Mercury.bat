...
while ($true) {
    cls
    Write-Host "Mercury Configuration" -F Yellow
    Write-Host
    Write-Host "[1] Install Mercury"
    Write-Host "[2] Tweak Mercury"
    ...
    switch ($choice) {
        '1' {
            cls
            & "$env:SystemRoot\RapidScripts\Playbook\Software.ps1" -Software Install-Mercury
        }
        '2' {
            cls
