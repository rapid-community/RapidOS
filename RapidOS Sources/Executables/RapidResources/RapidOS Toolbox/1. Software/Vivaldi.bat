...
while ($true) {
    cls
    Write-Host "Vivaldi Configuration" -F Yellow
    Write-Host
    Write-Host "[1] Install Vivaldi"
    Write-Host "[2] Tweak Vivaldi"
    ...
    switch ($choice) {
        ...
        '2' {
            cls
            Write-Host "There are no optimizations for Vivaldi and never will be."
        }
        '3' {
